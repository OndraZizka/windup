...
public class GetTagsFromFileClassificationsAndHints implements WindupFreeMarkerMethod
{
    ...
    public Object exec(@SuppressWarnings("rawtypes") List arguments) throws TemplateModelException
    {
        ...
        System.out.println("HHHHHHH getTagsFromFileClassificationsAndHints");///
    ...
    private Set<String> findTagsFromFileClassificationsAndHints(FileModel fileModel)
    {
        ...
        // Hints
        {
            ...
            pipeline.in(InlineHintModel.FILE_MODEL).has(WindupVertexFrame.TYPE_PROP, Text.CONTAINS, InlineHintModel.TYPE);
